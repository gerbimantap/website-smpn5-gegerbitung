...
if (typeof document !== "undefined") {
  ...
  style.textContent = `
    ...
    #footerPremium .footer-contact .maps-link{display:flex;gap:9px;align-items:center;color:#fff;text-decoration:none;font-weight:700;padding:8px 10px;margin:-2px -10px 0;border-radius:10px;background:rgba(255,255,255,.08);transition:background .2s ease,transform .2s ease}
    #footerPremium .footer-contact .maps-link:hover{background:rgba(255,255,255,.15);transform:translateX(2px)}
    #footerPremium .maps-icon{width:25px;height:25px;flex:0 0 25px;display:grid;place-items:center}
    #footerPremium .maps-icon svg{width:25px;height:25px;display:block}
  ...
  function addPremiumFooter(){if(document.getElementById("footerPremium"))return;const footer=document.querySelector("footer");if(!footer)return;const section=document.createElement("section");section.id="footerPremium";section.innerHTML=`<div class="container"><div class="footer-grid"><div class="footer-main"><div class="footer-brand"><img class="footer-logo" src="./logo%20sekolah.jpeg" alt="Logo SMPN 5 Gegerbitung"><div><h2 class="footer-school-name">SMPN 5 Gegerbitung</h2><div class="footer-school-sub">Unggul • Berkarakter • Berprestasi</div></div></div><p class="footer-desc">Website resmi SMPN 5 Gegerbitung sebagai media informasi, publikasi kegiatan, prestasi, dan layanan pendidikan bagi warga sekolah serta masyarakat.</p><div class="footer-socials"><a class="footer-social" href="https://youtube.com/@smpn5gegerbitung" target="_blank" rel="noopener noreferrer" aria-label="YouTube SMPN 5 Gegerbitung"><svg viewBox="0 0 24 24" fill="currentColor" aria-hidden="true"><path d="M23.5 6.2a3 3 0 0 0-2.1-2.1C19.5 3.5 12 3.5 12 3.5s-7.5 0-9.4.6A3 3 0 0 0 .5 6.2 31 31 0 0 0 0 12a31 31 0 0 0 .5 5.8 3 3 0 0 0 2.1 2.1c1.9.6 9.4.6 9.4.6s7.5 0 9.4-.6a3 3 0 0 0 2.1-2.1A31 31 0 0 0 24 12a31 31 0 0 0-.5-5.8ZM9.6 15.9V8.1l6.5 3.9-6.5 3.9Z"/></svg></a><a class="footer-social" href="https://www.instagram.com/smpn_5_gegerbitung" target="_blank" rel="noopener noreferrer" aria-label="Instagram SMPN 5 Gegerbitung"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" aria-hidden="true"><rect x="3" y="3" width="18" height="18" rx="5"/><circle cx="12" cy="12" r="4"/><circle cx="17.5" cy="6.5" r="1" fill="currentColor" stroke="none"/></svg></a></div></div><div><h3 class="footer-heading">Tautan Cepat</h3><div class="footer-links"><a href="#beranda">Beranda</a><a href="#profil">Profil Sekolah</a><a href="#guru-tendik">Guru & Tendik</a><a href="#kegiatan">Kegiatan Sekolah</a><a href="#program-unggulan">Program Unggulan</a><a href="#galeri">Galeri</a></div></div><div><h3 class="footer-heading">Informasi</h3><div class="footer-contact"><a class="maps-link" href="https://www.google.com/maps/search/?api=1&query=SMPN%205%20Gegerbitung%20Kabupaten%20Sukabumi" target="_blank" rel="noopener noreferrer" aria-label="Buka SMPN 5 Gegerbitung di Google Maps"><span class="maps-icon"><svg viewBox="0 0 32 32" aria-hidden="true"><path fill="#EA4335" d="M16 2.5C9.65 2.5 4.5 7.55 4.5 13.8c0 8.25 9.4 15.05 10.8 16.05.4.2.9.2 1.4 0 1.4-1 10.8-7.8 10.8-16.05C27.5 7.55 22.35 2.5 16 2.5Z"/><path fill="#FBBC04" d="M4.8 12.2c.8-5.5 5.55-9.7 11.2-9.7 2.55 0 4.9.8 6.8 2.15l-4.3 4.3a7.2 7.2 0 0 0-2.5-.45c-3.15 0-5.8 2.25-6.4 5.25Z"/><path fill="#34A853" d="M10.2 13.75a6.05 6.05 0 0 0 1.65 3.9l-3.75 3.75c-2.2-2.05-3.55-4.8-3.6-7.8Z"/><path fill="#4285F4" d="M11.85 17.65A6.05 6.05 0 0 0 16 19.2c3.05 0 5.6-2.15 6.25-5.05h5.2c-.75 6.05-5.6 10.75-11.45 10.75-3.25 0-6.2-1.3-8.35-3.5Z"/><circle cx="16" cy="13.8" r="4" fill="#fff"/><circle cx="16" cy="13.8" r="2.1" fill="#4285F4"/></svg></span><span>SMP Negeri 5 Gegerbitung<br>Kabupaten Sukabumi<br><small style="font-weight:600;opacity:.72">Buka di Google Maps</small></span></a><a href="https://youtube.com/@smpn5gegerbitung" target="_blank" rel="noopener noreferrer" style="color:inherit;text-decoration:none">▶ <span>Channel YouTube Resmi</span></a><a href="https://www.instagram.com/smpn_5_gegerbitung" target="_blank" rel="noopener noreferrer" style="color:inherit;text-decoration:none">◎ <span>Instagram Resmi Sekolah</span></a></div></div></div><div class="footer-bottom"><span>© 2026 <strong>SMPN 5 Gegerbitung</strong>. All rights reserved.</span><span>Website Sekolah • Kabupaten Sukabumi</span></div></div>`;footer.insertAdjacentElement("beforebegin",section);footer.style.display="none"}
